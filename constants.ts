...
export const ORE_DATA: Ore[] = [
    ...
    // The Peak Area
    { id: 62, name: "Mistvein", multiplier: 7.2, rarity: "rare", area: "peak", color: "#A9A9A9", traitType: null, traits: [], description: "Veined with drifting fog trapped inside the rock. Crack it open and the mist escapes instantly.", dropChance: "1/2626", price: 135 },
    { id: 63, name: "Lgarite", multiplier: 7.5, rarity: "rare", area: "peak", color: "#708090", traitType: null, traits: [], description: "Jagged and oddly refined at the same time. Looks artificial, but no one remembers making it.", dropChance: "1/3131", price: 140.63 },
    { id: 64, name: "Voidfractal", multiplier: 8, rarity: "rare", area: "peak", color: "#483D8B", traitType: null, traits: [], description: "Endless patterns folded into solid matter. Staring too long makes your head hurt.", dropChance: "1/3456", price: 150 },
    { id: 65, name: "Moltenfrost", multiplier: 8.3, rarity: "epic", area: "peak", color: "#FF4500", traitType: null, traits: [], description: "Burns and freezes at the same time. Physics gave up trying to explain this one.", dropChance: "1/4004", price: 155.63 },
    { id: 66, name: "Crimsonite", multiplier: 8.5, rarity: "epic", area: "peak", color: "#DC143C", traitType: "all", traits: [{ description: "+20% Physical Damage (BOTH)", scaling: {}, type: "all" }], description: "A deep red ore that radiates heat and anger. Miners swear it pulses when blood is nearby.", dropChance: "1/4540", price: 159.38 },
    { id: 67, name: "Malachite", multiplier: 8.8, rarity: "epic", area: "peak", color: "#00FA9A", traitType: "weapon", traits: [{ description: "Deals +10% of weapon damage as poison per second for 3 seconds. 33% chance on hit (Weapon)", scaling: {}, type: "weapon" }], description: "Green, layered, and rich with minerals. Breaks cleanly, like it's used to being harvested.", dropChance: "1/5123", price: 165 },
    { id: 68, name: "Aquajade", multiplier: 9, rarity: "epic", area: "peak", color: "#7FFFD4", traitType: null, traits: [], description: "Smooth, cool and heavy with ocean energy. Feels like it's been underwater longer than history.", dropChance: "1/5555", price: 168.75 },
    { id: 69, name: "Cryptex", multiplier: 9.3, rarity: "epic", area: "peak", color: "#8A2BE2", traitType: null, traits: [], description: "Layered with shifting patterns that never stay the same. No one agrees on what's inside, or if its watching.", dropChance: "1/6060", price: 174.38 },
    { id: 70, name: "Galestor", multiplier: 9.5, rarity: "epic", area: "peak", color: "#87CEEB", traitType: null, traits: [], description: "Lightweight and charged with constant motion. Even at rest, it feels like it wants to escape", dropChance: "1/6666", price: 178.13 },
    { id: 71, name: "Voidstar", multiplier: 10, rarity: "legendary", area: "peak", color: "#191970", traitType: "weapon", traits: [{ description: "+33 crit chance | +15% crit damage | -15% vitality (Weapon)", scaling: {}, type: "weapon" }], description: "A collapsed point of pure darkness. It absorbs light, sound and occasionally hope.", dropChance: "1/8179", price: 187.5 },
    { id: 72, name: "Etherealite", multiplier: 11.1, rarity: "mythical", area: "peak", color: "#E6E6FA", traitType: "armor", traits: [{ description: "+35% Vitality (Armor)", scaling: {}, type: "armor" }], description: "Almost invisible unless the light hits it just right. It flickers between existing and not bothering to.", dropChance: "1/11111", price: 208.13 },
    { id: 73, name: "Suryafal", multiplier: 17.5, rarity: "relic", area: "peak", color: "#FFD700", traitType: null, traits: [], description: "Sun-charged stone that radiates steady heat. Mining it feels like standing too close to daylight", dropChance: "1/50050", price: 328.13 },
    { id: 74, name: "Heavenite", multiplier: 25, rarity: "divine", area: "peak", color: "#F0F8FF", traitType: null, traits: [], description: "Warm to the touch and faintly glowing. Some say it fell from the sky, others say it was pushed.", dropChance: "1/157775", price: 0 },
    { id: 75, name: "Gargantuan", multiplier: 33.3, rarity: "divine", area: "peak", color: "#2F4F4F", traitType: "weapon", traits: [{ description: "Deals 20% of weapon damage as fire per seconds for 2 seconds. 20% chance on hit. Cause an explosion at location of victim, dealing 50% of weapon damage as AOE damage. 35% chance on hit (WEAPON)", scaling: {}, type: "weapon" }], description: "Dense, oversized, and brutally heavy. It takes effort just to remind it who's holding the pickaxe.", dropChance: "1/333333", price: 624.38 },
    { id: 76, name: "Mosasaursit", multiplier: 7, rarity: "exotic", area: "peak", color: "#B0C4DE", traitType: "all", traits: [{ description: "-25% swiftness and +65% vitality", scaling: {}, type: "all" }], description: "A fossilized skeleton of a prehistoric sea creature, its bones preserved by the cold waters of the island..", dropChance: "1/1", price: 135.25 }
];
