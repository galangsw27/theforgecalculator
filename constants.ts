...
export const ORE_DATA: Ore[] = [
    // Stonewake's Cross
    { id: 1, name: "Stone", multiplier: 0.2, rarity: "common", area: "stonewake", color: "#7b7773", traitType: null, traits: [], image: "/assets/images/ores/stone.png", description: "It's a rock. What more do you want?", dropChance: "1/1", price: 3 },
    { id: 2, name: "Sand Stone", multiplier: 0.25, rarity: "common", area: "stonewake", color: "#c3a777", traitType: null, traits: [], image: "/assets/images/ores/sand-stone.png", description: "Crumbly yet sturdy enough to build with. Not great with water.", dropChance: "1/2", price: 3.75 },
    { id: 3, name: "Copper", multiplier: 0.3, rarity: "common", area: "stonewake", color: "#925d3e", traitType: null, traits: [], image: "/assets/images/ores/copper.png", description: "Basic but dependable. A beginner's best friend in the forge.", dropChance: "1/3", price: 4.5 },
    { id: 4, name: "Iron", multiplier: 0.35, rarity: "common", area: "stonewake", color: "#827356", traitType: null, traits: [], image: "/assets/images/ores/iron.png", description: "The workhorse of the forge. Reliable, versatile and a classic choice.", dropChance: "1/5", price: 5.25 },
    { id: 5, name: "Tin", multiplier: 0.425, rarity: "uncommon", area: "stonewake", color: "#69707b", traitType: null, traits: [], image: "/assets/images/ores/tin.png", description: "Weak on its own, but blends beautifully with others.", dropChance: "1/7", price: 6.38 },
    { id: 6, name: "Silver", multiplier: 0.5, rarity: "uncommon", area: "stonewake", color: "#bad0e0", traitType: null, traits: [], image: "/assets/images/ores/silver.png", description: "Malleable and pure. Naturally anti-curse, anti-werewolf, anti-everything-bad.", dropChance: "1/12", price: 7.5 },
    { id: 7, name: "Gold", multiplier: 0.65, rarity: "uncommon", area: "stonewake", color: "#c89d40", traitType: null, traits: [], image: "/assets/images/ores/gold.png", description: "Not the strongest, but hey–it's gold. Fancy never goes out of style.", dropChance: "1/16", price: 19.5 },
    { id: 8, name: "Mushroomite", multiplier: 0.8, rarity: "rare", area: "stonewake", color: "#9b8768", traitType: null, traits: [], image: "/assets/images/ores/mushroomite.png", description: "Grows in damp places. Sometimes glows. Sometimes talks. Probably fine.", dropChance: "1/22", price: 12 },
    { id: 9, name: "Platinum", multiplier: 0.8, rarity: "rare", area: "stonewake", color: "#d6dee6", traitType: null, traits: [], image: "/assets/images/ores/platinum.png", description: "Smooth, silvery, and highly conductive. Rare and sought-after.", dropChance: "1/28", price: 12 },
    { id: 10, name: "Bananite", multiplier: 0.85, rarity: "uncommon", area: "stonewake", color: "#edbe70", traitType: null, traits: [], image: "/assets/images/ores/bananite.png", description: "Yellow, slippery, looks and smells like banana yet surprisingly durable.", dropChance: "1/30", price: 12.75 },
    { id: 11, name: "Cardboardite", multiplier: 0.7, rarity: "common", area: "stonewake", color: "#a28161", traitType: null, traits: [], image: "/assets/images/ores/cardboardite.png", description: "Looks like trash, feels like trash... but somehow incredibly useful.", dropChance: "1/31", price: 10.5 },
    { id: 12, name: "Aite", multiplier: 1.0, rarity: "epic", area: "stonewake", color: "#f0d2a7", traitType: null, traits: [], image: "/assets/images/ores/aite.png", description: "It's an ore made out of A's – but actually lightweight and razor sharp.", dropChance: "1/44", price: 16.5 },
    {
        ...
        image: "/assets/images/ores/poopite.png",
    ...
    // Forgotten Kingdom
    { id: 14, name: "Cobalt", multiplier: 1.0, rarity: "uncommon", area: "kingdom", color: "#579de7", traitType: null, traits: [], image: "/assets/images/ores/cobalt.png", description: "A sturdy bluish metal known for its resilience and sharp edges.", dropChance: "1/37", price: 15 },
    { id: 15, name: "Titanium", multiplier: 1.15, rarity: "uncommon", area: "kingdom", color: "#aca895", traitType: null, traits: [], image: "/assets/images/ores/titanium.png", description: "One of the strongest metals. Lightweight, almost unbreakable.", dropChance: "1/50", price: 17.25 },
    { id: 17, name: "Lapis Lazuli", multiplier: 1.3, rarity: "uncommon", area: "kingdom", color: "#5c89dc", traitType: null, traits: [], image: "/assets/images/ores/lapis-lazuli.png", description: "Deep blue with ancient markings. Scholars say it stores memories.", dropChance: "1/73", price: 22.5 },
    { id: 44, name: "Boneite", multiplier: 1.2, rarity: "rare", area: "kingdom", color: "#e3e3e3", traitType: null, traits: [], image: "/assets/images/ores/boneite.jpg", description: "A pale, brittle ore formed from shattered skeleton remains, still carrying faint undead energy.", dropChance: "1/222", price: 18 },
    { id: 16, name: "Volcanic Rock", multiplier: 1.55, rarity: "rare", area: "kingdom", color: "#504b44", traitType: null, traits: [], image: "/assets/images/ores/volcanic-rock.png", description: "It's not a just a rock. What more do you want?", dropChance: "1/55", price: 23.25 },
    { id: 18, name: "Quartz", multiplier: 1.5, rarity: "rare", area: "kingdom", color: "#b6dffd", traitType: null, traits: [], image: "/assets/images/ores/quartz.png", description: "Translucent and mystical. Often used to amplify rune energy.", dropChance: "1/90", price: 22.5 },
    { id: 19, name: "Amethyst", multiplier: 1.65, rarity: "rare", area: "kingdom", color: "#957aed", traitType: null, traits: [], image: "/assets/images/ores/amethyst.png", description: "A shimmering purple gem, pulsing with magical energy.", dropChance: "1/115", price: 24.75 },
    { id: 20, name: "Topaz", multiplier: 1.75, rarity: "rare", area: "kingdom", color: "#deb7a4", traitType: null, traits: [], image: "/assets/images/ores/topaz.png", description: "Golden yellow and warm. Used in enchanting precision tools.", dropChance: "1/143", price: 26.25 },
    { id: 21, name: "Diamond", multiplier: 2.0, rarity: "rare", area: "kingdom", color: "#aef8fa", traitType: null, traits: [], image: "/assets/images/ores/diamond.png", description: "The hardest known material.", dropChance: "1/192", price: 30 },
    { id: 45, name: "Dark boneite", multiplier: 2.25, rarity: "rare", area: "kingdom", color: "#2b2b2b", traitType: null, traits: [], image: "/assets/images/ores/dark-boneite.jpg", description: "A pale, brittle ore formed from shattered skeleton remains, still carrying faint undead energy", dropChance: "1/555", price: 33.75 },
    { id: 22, name: "Sapphire", multiplier: 2.25, rarity: "rare", area: "kingdom", color: "#7bbdfa", traitType: null, traits: [], image: "/assets/images/ores/sapphire.png", description: "Deep blue and ice-cold. Sold to sharpen senses when worn.", dropChance: "1/247", price: 33.75 },
    { id: 23, name: "Cuprite", multiplier: 2.43, rarity: "epic", area: "kingdom", color: "#7a3034", traitType: null, traits: [], image: "/assets/images/ores/cuprite.png", description: "A bright red metallic ore found near river rocks.", dropChance: "1/303", price: 36.45 },
    {
        id: 24, name: "Obsidian", multiplier: 2.35, rarity: "epic", area: "kingdom", color: "#4b2e87", traitType: "armor", traits: [
            { description: "30% extra defense on Armor", scaling: { def: { min: 0.03, max: 0.30 } }, type: "armor" }
        ],
        image: "/assets/images/ores/obsidian.png",
        description: "Volcanic glass as sharp as it is strong.",
        dropChance: "1/333",
        price: 35.25
    },
    { id: 25, name: "Emerald", multiplier: 2.55, rarity: "epic", area: "kingdom", color: "#5fb172", traitType: null, traits: [], image: "/assets/images/ores/emerald.png", description: "Vivid green and unnaturally smooth.", dropChance: "1/363", price: 38.25 },
    { id: 26, name: "Ruby", multiplier: 2.95, rarity: "epic", area: "kingdom", color: "#cc4a53", traitType: null, traits: [], image: "/assets/images/ores/ruby.png", description: "A blood-red gem that gleams with fury.", dropChance: "1/487", price: 44.25 },
    {
        ...
        image: "/assets/images/ores/rivalite.png",
        description: "A reactive ore that strengthens when near other powerful metals.",
        dropChance: "1/569",
        price: 49.95
    },
    { id: 46, name: "Slimite", multiplier: 2.25, rarity: "epic", area: "kingdom", color: "#66ff66", traitType: null, traits: [], image: "/assets/images/ores/slimite.jpg", description: "A slime-like ore that wiggles, and leaves a faint slime glow.", dropChance: "1/247", price: 33.75 },
    {
        ...
        image: "/assets/images/ores/uranium.png",
    ...
    },
    {
        id: 29, name: "Mythril", multiplier: 3.5, rarity: "legendary", area: "kingdom", color: "#9f61fa", traitType: "armor", traits: [
            { description: "15% extra defense on Armor", scaling: { def: { min: 0.015, max: 0.15 } }, type: "armor" }
        ],
        image: "/assets/images/ores/mythril.png",
    ...
    },
    {
        id: 30, name: "Eye Ore", multiplier: 4.0, rarity: "legendary", area: "kingdom", color: "#fab67f", traitType: "all", traits: [
            { description: "-10% HP, +15% dmg on Weapons/Armor", scaling: { damage: { min: 0.015, max: 0.15 }, health: { min: -0.01, max: -0.10 } }, type: "all" }
        ],
        image: "/assets/images/ores/eye-ore.png",
    ...
    },
    {
        id: 31, name: "Fireite", multiplier: 4.5, rarity: "legendary", area: "kingdom", color: "#a4532e", traitType: "weapon", traits: [
            { description: "20% burn chance on Weapons", scaling: { damage: { min: 0.02, max: 0.20 }, chance: { min: 0.30, max: 0.30 } }, type: "weapon" }
        ],
        image: "/assets/images/ores/fireite.png",
    ...
    },
    {
        id: 32, name: "Magmaite", multiplier: 5.0, rarity: "legendary", area: "kingdom", color: "#f77b61", traitType: "weapon", traits: [
            { description: "50.00% of weapon dmg as AOE Explosion with 35.00% chance on weapons", scaling: { damage: { min: 0.05, max: 0.50 }, chance: { min: 0.35, max: 0.35 } }, type: "weapon" }
        ],
        image: "/assets/images/ores/magmaite.png",
    ...
    },
    {
        ...
        image: "/assets/images/ores/lightite.png",
    ...
    },
    {
        id: 34, name: "Demonite", multiplier: 5.5, rarity: "mythical", area: "kingdom", color: "#7d1b1d", traitType: "armor", traits: [
            { description: "25.00% to Burn Enemy when Damage is Taken. On Armor.", scaling: { damage: { min: 0.02, max: 0.20 }, chance: { min: 0.15, max: 0.15 } }, type: "armor" }
        ],
        image: "/assets/images/ores/demonite.png",
    ...
    },
    {
        id: 35, name: "Darkryte", multiplier: 6.3, rarity: "mythical", area: "kingdom", color: "#f0f0f0", traitType: "armor", traits: [
            { description: "15.00% Chance to Dodge Damage (Negate Fully). On Armor.", scaling: { chance: { min: 0.015, max: 0.15 } }, type: "armor" }
        ],
        image: "/assets/images/ores/darkryte.png",
        description: "A shadowy ore that absorbs light.",
        dropChance: "1/6655",
        price: 94.5
    },
    // Goblin Area
    { id: 39, name: "Orange Crystal Ore", multiplier: 3.0, rarity: "epic", area: "goblin", color: "#d8792a", traitType: null, traits: [], image: "/assets/images/ores/orange-crystal-ore.png", description: "No description available.", dropChance: "1/255", price: 45 },
    { id: 36, name: "Magenta Crystal Ore", multiplier: 3.1, rarity: "epic", area: "goblin", color: "#795ef8", traitType: null, traits: [], image: "/assets/images/ores/magenta-crystal-ore.png", description: "No description available.", dropChance: "1/255", price: 46.5 },
    { id: 38, name: "Green Crystal Ore", multiplier: 3.2, rarity: "epic", area: "goblin", color: "#68c87b", traitType: null, traits: [], image: "/assets/images/ores/green-crystal-ore.png", description: "No description available.", dropChance: "1/255", price: 48 },
    { id: 37, name: "Crimson Crystal Ore", multiplier: 3.3, rarity: "epic", area: "goblin", color: "#9a5065", traitType: null, traits: [], image: "/assets/images/ores/crimson-crystal-ore.png", description: "No description available.", dropChance: "1/255", price: 49.5 },
    { id: 40, name: "Blue Crystal Ore", multiplier: 3.4, rarity: "epic", area: "goblin", color: "#699cf1", traitType: null, traits: [], image: "/assets/images/ores/blue-crystal-ore.png", description: "No description available.", dropChance: "1/255", price: 51 },
    { id: 41, name: "Rainbow Crystal Ore", multiplier: 5.25, rarity: "legendary", area: "goblin", color: "#1b7c3a", traitType: null, traits: [], image: "/assets/images/ores/rainbow-crystal-ore.png", description: "No description available.", dropChance: "1/5000", price: 78.75 },
    { id: 42, name: "Arcane Crystal Ore", multiplier: 7.5, rarity: "mythical", area: "goblin", color: "#c8dbf5", traitType: null, traits: [], image: "/assets/images/ores/arcane-crystal-ore.png", description: "No description available.", dropChance: "1/100000", price: 112.5 },
    ...
    // Frostpire Area
    { id: 48, name: "Tungsten Ore", multiplier: 2.6, rarity: "common", area: "frostpire", color: "#4a4a4a", traitType: null, traits: [], image: "/assets/images/ores/tungsten-ore.jpg", description: "Unyielding and absurdly dense. You feel more motivated just holding it.", dropChance: "1/180", price: 48.75 },
    { id: 49, name: "Sulfur Ore", multiplier: 2.75, rarity: "uncommon", area: "frostpire", color: "#E6E65C", traitType: null, traits: [], image: "/assets/images/ores/sulfur-ore.jpg", description: "Yellow, brittle, and smells exactly how you expect. Useful, dangerous, and easy to regret.", dropChance: "1/215", price: 51.56 },
    { id: 50, name: "Pumice Ore", multiplier: 2.9, rarity: "rare", area: "frostpire", color: "#D3D3D3", traitType: null, traits: [], image: "/assets/images/ores/pumice-ore.jpg", description: "Light, brittle, and full of air pockets. Floats briefly before remembering it’s a rock.", dropChance: "1/265", price: 54.38 },
    { id: 51, name: "Graphite Ore", multiplier: 3.1, rarity: "rare", area: "frostpire", color: "#2F4F4F", traitType: "all", traits: [{ description: "+5% Increased Vitality, and has a 20% chance to reduce Incoming Damage by 12%.", scaling: { health: { min: 0.05, max: 0.05 }, def: { min: 0.12, max: 0.12 }, chance: { min: 0.20, max: 0.20 } }, type: "all" }], image: "/assets/images/ores/graphite-ore.jpg", description: "Plain, dark, and deceptively useful. Not flashy, but it gets the job done without complaints.", dropChance: "1/315", price: 58.13 },
    { id: 52, name: "Aetherit Ore", multiplier: 3.4, rarity: "rare", area: "frostpire", color: "#9370DB", traitType: "all", traits: [{ description: "+5% Increased Movement Speed.", scaling: {}, type: "all" }], image: "/assets/images/ores/aetherit-ore.jpg", description: "A broken piece of raw magic. Sharp, unstable, and absolutely not safe to pocket.", dropChance: "1/390", price: 63.75 },
    { id: 53, name: "Scheelite Ore", multiplier: 3.3, rarity: "rare", area: "frostpire", color: "#FFA500", traitType: null, traits: [], image: "/assets/images/ores/scheelite-ore.jpg", description: "Dull at first glance, valuable once refined. The kind of ore that rewards patience.", dropChance: "1/247", price: 69.38 },
    { id: 54, name: "Larimar Ore", multiplier: 4.1, rarity: "epic", area: "frostpire", color: "#00BFFF", traitType: null, traits: [], image: "/assets/images/ores/larimar-ore.jpg", description: "Soft blue stone infused with calm energy. Holding it makes the caves feel less hostile, briefly.", dropChance: "1/575", price: 76.88 },
    { id: 55, name: "Neurotite Ore", multiplier: 4.3, rarity: "epic", area: "frostpire", color: "#FF69B4", traitType: null, traits: [], image: "/assets/images/ores/neurotite-ore.jpg", description: "Warm and faintly organic in texture. Staying near it too long gives you strange ideas.", dropChance: "1/690", price: 80.63 },
    { id: 56, name: "Frost Fossil Ore", multiplier: 4.5, rarity: "epic", area: "frostpire", color: "#E0FFFF", traitType: "all", traits: [{ description: "+17.5% Increased Physical Damage and -5% reduced Movement Speed.", scaling: { damage: { min: 0.175, max: 0.175 } }, type: "all" }], image: "/assets/images/ores/frost-fossil-ore.jpg", description: "Ancient remains frozen solid in eternal ice. Whatever it once was, it never got to finish dying.", dropChance: "1/820", price: 84.38 },
    { id: 57, name: "Tide Carve Ore", multiplier: 4.7, rarity: "epic", area: "frostpire", color: "#4682B4", traitType: null, traits: [], image: "/assets/images/ores/tide-carve-ore.jpg", description: "Shaped by relentless water pressure. Every edge tells a story of erosion and survival.", dropChance: "1/980", price: 88.13 },
    { id: 58, name: "Velchire Ore", multiplier: 5.5, rarity: "legendary", area: "frostpire", color: "#4169E1", traitType: "all", traits: [{ description: "+20% Increased Movement Speed.", scaling: {}, type: "all" }], image: "/assets/images/ores/velchire-ore.jpg", description: "Smooth, refined, and unnaturally cold. Looks expensive even before forging.", dropChance: "1/1450", price: 103.13 },
    { id: 59, name: "Sanctis Ore", multiplier: 6, rarity: "legendary", area: "frostpire", color: "#FFFACD", traitType: "all", traits: [{ description: "+18% Increased Stamina.", scaling: {}, type: "all" }], image: "/assets/images/ores/sanctis-ore.jpg", description: "Clean, radiant, and unnervingly pure. Feels wrong to break, but you do it anyway.", dropChance: "1/1830", price: 112.5 },
    { id: 60, name: "Snowite Ore", multiplier: 8, rarity: "legendary", area: "frostpire", color: "#FFFAFA", traitType: "weapon", traits: [{ description: "+15% to Attack Speed of your Weapon, and reduces Movement Speed of Enemies for 3 Seconds. 30% Chance to Hit.", scaling: { atkSpeed: { min: 0.015, max: 0.15 }, chance: { min: 0.30, max: 0.30 } }, type: "weapon" }], image: "/assets/images/ores/snowite-ore.jpg", description: "Light, sharp, and infused with wind energy. It almost floats when freshly mined.", dropChance: "1/4325", price: 150 },
    { id: 61, name: "Iceite", multiplier: 10.5, rarity: "mythical", area: "frostpire", color: "#00FFFF", traitType: "weapon", traits: [{ description: "25% Chance to Freeze Enemies for 2 seconds, 12 second Cooldown.", scaling: {}, type: "weapon" }], image: "/assets/images/ores/iceite.jpg", description: "Light, sharp, and infused with wind energy. It almost floats when freshly mined.", dropChance: "1/9898", price: 196.88 },

    // The Peak Area
    { id: 62, name: "Mistvein", multiplier: 7.2, rarity: "rare", area: "peak", color: "#A9A9A9", traitType: null, traits: [], image: "/assets/images/ores/mistvein.png", description: "Veined with drifting fog trapped inside the rock. Crack it open and the mist escapes instantly.", dropChance: "1/2626", price: 135 },
    { id: 63, name: "Lgarite", multiplier: 7.5, rarity: "rare", area: "peak", color: "#708090", traitType: null, traits: [], image: "/assets/images/ores/lgarite.png", description: "Jagged and oddly refined at the same time. Looks artificial, but no one remembers making it.", dropChance: "1/3131", price: 140.63 },
    { id: 64, name: "Voidfractal", multiplier: 8, rarity: "rare", area: "peak", color: "#483D8B", traitType: null, traits: [], image: "/assets/images/ores/voidfractal.png", description: "Endless patterns folded into solid matter. Staring too long makes your head hurt.", dropChance: "1/3456", price: 150 },
    { id: 65, name: "Moltenfrost", multiplier: 8.3, rarity: "epic", area: "peak", color: "#FF4500", traitType: null, traits: [], image: "/assets/images/ores/moltenfrost.png", description: "Burns and freezes at the same time. Physics gave up trying to explain this one.", dropChance: "1/4004", price: 155.63 },
    { id: 66, name: "Crimsonite", multiplier: 8.5, rarity: "epic", area: "peak", color: "#DC143C", traitType: "all", traits: [{ description: "+20% Physical Damage (BOTH)", scaling: { damage: { min: 0.20, max: 0.20 } }, type: "all" }], image: "/assets/images/ores/crimsonite.png", description: "A deep red ore that radiates heat and anger. Miners swear it pulses when blood is nearby.", dropChance: "1/4540", price: 159.38 },
    { id: 67, name: "Malachite", multiplier: 8.8, rarity: "epic", area: "peak", color: "#00FA9A", traitType: "weapon", traits: [{ description: "Deals +10% of weapon damage as poison per second for 3 seconds. 33% chance on hit (Weapon)", scaling: { damage: { min: 0.10, max: 0.10 }, duration: { min: 3, max: 3 }, chance: { min: 0.33, max: 0.33 } }, type: "weapon" }], image: "/assets/images/ores/malachite.png", description: "Green, layered, and rich with minerals. Breaks cleanly, like it's used to being harvested.", dropChance: "1/5123", price: 165 },
    { id: 68, name: "Aquajade", multiplier: 9, rarity: "epic", area: "peak", color: "#7FFFD4", traitType: null, traits: [], image: "/assets/images/ores/aquajade.png", description: "Smooth, cool and heavy with ocean energy. Feels like it's been underwater longer than history.", dropChance: "1/5555", price: 168.75 },
    { id: 69, name: "Cryptex", multiplier: 9.3, rarity: "epic", area: "peak", color: "#8A2BE2", traitType: null, traits: [], image: "/assets/images/ores/cryptex.png", description: "Layered with shifting patterns that never stay the same. No one agrees on what's inside, or if its watching.", dropChance: "1/6060", price: 174.38 },
    { id: 70, name: "Galestor", multiplier: 9.5, rarity: "epic", area: "peak", color: "#87CEEB", traitType: null, traits: [], image: "/assets/images/ores/galestor.png", description: "Lightweight and charged with constant motion. Even at rest, it feels like it wants to escape", dropChance: "1/6666", price: 178.13 },
    { id: 71, name: "Voidstar", multiplier: 10, rarity: "legendary", area: "peak", color: "#191970", traitType: "weapon", traits: [{ description: "+33 crit chance | +15% crit damage | -15% vitality (Weapon)", scaling: { health: { min: -0.15, max: -0.15 } }, type: "weapon" }], image: "/assets/images/ores/voidstar.png", description: "A collapsed point of pure darkness. It absorbs light, sound and occasionally hope.", dropChance: "1/8179", price: 187.5 },
    { id: 72, name: "Etherealite", multiplier: 11.1, rarity: "mythical", area: "peak", color: "#E6E6FA", traitType: "armor", traits: [{ description: "+35% Vitality (Armor)", scaling: { health: { min: 0.35, max: 0.35 } }, type: "armor" }], image: "/assets/images/ores/etherealite.png", description: "Almost invisible unless the light hits it just right. It flickers between existing and not bothering to.", dropChance: "1/11111", price: 208.13 },
    { id: 73, name: "Suryafal", multiplier: 15, rarity: "relic", area: "peak", color: "#FFD700", traitType: null, traits: [], image: "/assets/images/ores/suryafal.png", description: "Sun-charged stone that radiates steady heat. Mining it feels like standing too close to daylight", dropChance: "1/50050", price: 328.13 },
    { id: 74, name: "Heavenite", multiplier: 20, rarity: "divine", area: "peak", color: "#F0F8FF", traitType: null, traits: [], image: "/assets/images/ores/heavenite.png", description: "Warm to the touch and faintly glowing. Some say it fell from the sky, others say it was pushed.", dropChance: "1/157775", price: 0 },
    { id: 75, name: "Gargantuan", multiplier: 25, rarity: "divine", area: "peak", color: "#2F4F4F", traitType: "weapon", traits: [{ description: "Deals 20% of weapon damage as fire per seconds for 2 seconds. 20% chance on hit. Cause an explosion at location of victim, dealing 50% of weapon damage as AOE damage. 35% chance on hit (WEAPON)", scaling: { damage: { min: 0.255, max: 0.255 }, chance: { min: 1.0, max: 1.0 } }, type: "weapon" }], image: "/assets/images/ores/gargantuan.png", description: "Dense, oversized, and brutally heavy. It takes effort just to remind it who's holding the pickaxe.", dropChance: "1/333333", price: 624.38 },
    { id: 76, name: "Mosasaursit", multiplier: 7, rarity: "exotic", area: "peak", color: "#B0C4DE", traitType: "all", traits: [{ description: "-25% swiftness and +65% vitality", scaling: { health: { min: 0.65, max: 0.65 } }, type: "all" }], image: "/assets/images/ores/mosasaursit.png", description: "A fossilized skeleton of a prehistoric sea creature, its bones preserved by the cold waters of the island..", dropChance: "1/1", price: 135.25 }
];
...
export const WORLD_WEAPON_DATA: Record<number, Record<string, Record<string, number>>> = {
    3: {
        "W1": { "Dagger": 0.25, "Falchion Knife": 0.50, "Gladius Dagger": 0.25 },
        "W2": { "Dagger": 0.6875, "Gladius Dagger": 0.25, "Hook": 0.0625 },
        "W3": { "Dagger": 0.6875, "Gladius Dagger": 0.25, "Hook": 0.0625 }
    },
    6: {
        "W1": { "Falchion": 0.2867, "Gladius": 0.4658, "Cutlass": 0.1075 },
        "W2": { "Falchion": 0.1612, "Cutlass": 0.43, "Rapier": 0.215, "Chaos": 0.0538 },
        "W3": { "Falchion": 0.0752, "Cutlass": 0.43, "Rapier": 0.215, "Chaos": 0.0538, "Hell Slayer": 0.086 }
    },
    9: {
        "W1": { "Ironhand": 0.4875, "Boxing Gloves": 0.1625 },
        "W2": { "Ironhand": 0.325, "Relevator": 0.1625, "Savage Claws": 0.1625 },
        "W3": { "Mace": 0.1016, "Spiked Mace": 0.325, "Winged Mace": 0.1625, "Hammerhead Mace": 0.0406, "Grave Maker": 0.0203 }
    },
    12: {
        "W1": { "Uchigatana": 0.72 },
        "W2": { "Uchigatana": 0.36, "Tachi": 0.36 },
        "W3": { "Axe": 0.14, "Battleaxe": 0.36, "Curved Handle Axe": 0.18, "Spade Armed Axe": 0.045 }
    },
    16: {
        "W1": { "Crusader Sword": 0.69 },
        "W2": { "Crusader Sword": 0.345, "Longsword": 0.345 },
        "W3": { "Spear": 0.1725, "Trident": 0.345, "Angelic Spear": 0.1725 }
    },
    22: {
        "W1": { "Double Battle Axe": 0.67 },
        "W2": { "Double Battle Axe": 0.5025, "Scythe": 0.1675 },
...
export const BASE_ITEM_STATS: Record<string, Record<string, ItemStat>> = {
    weapon: {
        ...
        "Candy Cane": { damage: 16.5, atkSpeed: 0.55, range: 8, price: 120, type: "Straight Sword" },
        "Hell Slayer": { damage: 19.5, atkSpeed: 0.62, range: 8, price: 120, type: "Straight Sword" },
        "Gauntlet": { damage: 14.5, atkSpeed: 0.48, range: 6, price: 205, type: "Gauntlet" },
        ...
        "Savage Claws": { damage: 20, atkSpeed: 0.72, range: 6, price: 205, type: "Gauntlet" },
        ...
        "Greater Battleaxe": { damage: 33, atkSpeed: 1.1, range: 9, price: 850, type: "Great Axe" },
        "Axe": { damage: 27, atkSpeed: 0.9, range: 9, price: 850, type: "Axe" },
        "Battleaxe": { damage: 27, atkSpeed: 0.9, range: 9, price: 850, type: "Axe" },
        "Curved Handle Axe": { damage: 29.5, atkSpeed: 0.98, range: 9, price: 850, type: "Axe" },
        "Spade Armed Axe": { damage: 30, atkSpeed: 1.0, range: 9, price: 850, type: "Axe" },
...
export const ITEM_VARIANTS: Record<string, Record<string, Record<string, { name: string, chance: string, probability: number }[]>>> = {
    weapon: {
        ...
        "Straight Sword": {
            "stonewake": [{ name: "Falchion", chance: "1/1", probability: 1.0 }, { name: "Gladius", chance: "1/2", probability: 0.5 }, { name: "Cutlass", chance: "1/4", probability: 0.25 }, { name: "Rapier", chance: "1/8", probability: 0.125 }, { name: "Chaos", chance: "1/16", probability: 0.0625 }, { name: "Candy Cane", chance: "1/6", probability: 0.167 }, { name: "Hell Slayer", chance: "1/6", probability: 0.167 }],
            "kingdom": [{ name: "Falchion", chance: "1/1", probability: 1.0 }, { name: "Gladius", chance: "1/2", probability: 0.5 }, { name: "Cutlass", chance: "1/4", probability: 0.25 }, { name: "Rapier", chance: "1/8", probability: 0.125 }, { name: "Chaos", chance: "1/16", probability: 0.0625 }, { name: "Candy Cane", chance: "1/6", probability: 0.167 }, { name: "Hell Slayer", chance: "1/6", probability: 0.167 }],
            "goblin": [{ name: "Falchion", chance: "1/1", probability: 1.0 }, { name: "Gladius", chance: "1/2", probability: 0.5 }, { name: "Cutlass", chance: "1/4", probability: 0.25 }, { name: "Rapier", chance: "1/8", probability: 0.125 }, { name: "Chaos", chance: "1/16", probability: 0.0625 }, { name: "Candy Cane", chance: "1/6", probability: 0.167 }, { name: "Hell Slayer", chance: "1/6", probability: 0.167 }],
            "enemy": [{ name: "Falchion", chance: "1/1", probability: 1.0 }, { name: "Gladius", chance: "1/2", probability: 0.5 }, { name: "Cutlass", chance: "1/4", probability: 0.25 }, { name: "Rapier", chance: "1/8", probability: 0.125 }, { name: "Chaos", chance: "1/16", probability: 0.0625 }, { name: "Candy Cane", chance: "1/6", probability: 0.167 }, { name: "Hell Slayer", chance: "1/6", probability: 0.167 }],
            "frostpire": [{ name: "Falchion", chance: "1/1", probability: 1.0 }, { name: "Gladius", chance: "1/2", probability: 0.5 }, { name: "Cutlass", chance: "1/4", probability: 0.25 }, { name: "Rapier", chance: "1/8", probability: 0.125 }, { name: "Chaos", chance: "1/16", probability: 0.0625 }, { name: "Candy Cane", chance: "1/6", probability: 0.167 }, { name: "Hell Slayer", chance: "1/6", probability: 0.167 }],
            "peak": [{ name: "Falchion", chance: "1/1", probability: 1.0 }, { name: "Gladius", chance: "1/2", probability: 0.5 }, { name: "Cutlass", chance: "1/4", probability: 0.25 }, { name: "Rapier", chance: "1/8", probability: 0.125 }, { name: "Chaos", chance: "1/16", probability: 0.0625 }, { name: "Candy Cane", chance: "1/6", probability: 0.167 }, { name: "Hell Slayer", chance: "1/6", probability: 0.167 }]
        },
        "Gauntlet": {
            "stonewake": [{ name: "Gauntlet", chance: "1/1", probability: 1.0 }, { name: "Ironhand", chance: "1/2", probability: 0.5 }, { name: "Boxing Gloves", chance: "1/4", probability: 0.25 }, { name: "Relevator", chance: "1/16", probability: 0.0625 }, { name: "Savage Claws", chance: "1/9", probability: 0.111 }],
            "kingdom": [{ name: "Gauntlet", chance: "1/1", probability: 1.0 }, { name: "Ironhand", chance: "1/2", probability: 0.5 }, { name: "Boxing Gloves", chance: "1/4", probability: 0.25 }, { name: "Relevator", chance: "1/16", probability: 0.0625 }, { name: "Savage Claws", chance: "1/9", probability: 0.111 }],
            "goblin": [{ name: "Gauntlet", chance: "1/1", probability: 1.0 }, { name: "Ironhand", chance: "1/2", probability: 0.5 }, { name: "Boxing Gloves", chance: "1/4", probability: 0.25 }, { name: "Relevator", chance: "1/16", probability: 0.0625 }, { name: "Savage Claws", chance: "1/9", probability: 0.111 }],
            "enemy": [{ name: "Gauntlet", chance: "1/1", probability: 1.0 }, { name: "Ironhand", chance: "1/2", probability: 0.5 }, { name: "Boxing Gloves", chance: "1/4", probability: 0.25 }, { name: "Relevator", chance: "1/16", probability: 0.0625 }, { name: "Savage Claws", chance: "1/9", probability: 0.111 }],
            "frostpire": [{ name: "Gauntlet", chance: "1/1", probability: 1.0 }, { name: "Ironhand", chance: "1/2", probability: 0.5 }, { name: "Boxing Gloves", chance: "1/4", probability: 0.25 }, { name: "Relevator", chance: "1/16", probability: 0.0625 }, { name: "Savage Claws", chance: "1/9", probability: 0.111 }],
            "peak": [{ name: "Gauntlet", chance: "1/1", probability: 1.0 }, { name: "Ironhand", chance: "1/2", probability: 0.5 }, { name: "Boxing Gloves", chance: "1/4", probability: 0.25 }, { name: "Relevator", chance: "1/16", probability: 0.0625 }, { name: "Savage Claws", chance: "1/9", probability: 0.111 }]
        },
        "Katana": {
            "stonewake": [{ name: "Uchigatana", chance: "1/1", probability: 1.0 }, { name: "Tachi", chance: "1/2", probability: 0.5 }, { name: "Grave Maker", chance: "1/9", probability: 0.111 }],
            "kingdom": [{ name: "Uchigatana", chance: "1/1", probability: 1.0 }, { name: "Tachi", chance: "1/2", probability: 0.5 }, { name: "Grave Maker", chance: "1/9", probability: 0.111 }],
            "goblin": [{ name: "Uchigatana", chance: "1/1", probability: 1.0 }, { name: "Tachi", chance: "1/2", probability: 0.5 }, { name: "Grave Maker", chance: "1/9", probability: 0.111 }],
            "enemy": [{ name: "Uchigatana", chance: "1/1", probability: 1.0 }, { name: "Tachi", chance: "1/2", probability: 0.5 }, { name: "Grave Maker", chance: "1/9", probability: 0.111 }],
            "frostpire": [{ name: "Uchigatana", chance: "1/1", probability: 1.0 }, { name: "Tachi", chance: "1/2", probability: 0.5 }, { name: "Grave Maker", chance: "1/9", probability: 0.111 }],
            "peak": [{ name: "Uchigatana", chance: "1/1", probability: 1.0 }, { name: "Tachi", chance: "1/2", probability: 0.5 }, { name: "Grave Maker", chance: "1/9", probability: 0.111 }]
        },
        "Great Sword": {
...
export const ITEM_IMAGES: Record<string, string> = {
    "Boxing Gloves": "/assets/images/items/boxing-gloves.png",
    "Chaos": "/assets/images/items/chaos.png",
    "Comically Large Spoon": "/assets/images/items/comically-large-spoon.png",
    "Crusader Sword": "/assets/images/items/crusader-sword.png",
    "Cutlass": "/assets/images/items/cutlass.png",
    "Dagger": "/assets/images/items/dagger.png",
    "Double Battle Axe": "/assets/images/items/double-battle-axe.png",
    "Dragon Slayer": "/assets/images/items/dragon-slayer.png",
    "Falchion Knife": "/assets/images/items/falchion-knife.png",
    "Falchion": "/assets/images/items/falchion.png",
    "Gladius Dagger": "/assets/images/items/gladius-dagger.png",
    "Gladius": "/assets/images/items/gladius.png",
    "Great Sword": "/assets/images/items/great-sword.png",
    "Hammer": "/assets/images/items/hammer.png",
    "Hook": "/assets/images/items/hook.png",
    "Gauntlet": "/assets/images/items/gauntlet.png",
    "Ironhand": "/assets/images/items/ironhand.png",
    "Long Sword": "/assets/images/items/long-sword.png",
    "Rapier": "/assets/images/items/rapier.png",
    "Relevator": "/assets/images/items/relevator.png",
    "Savage Claws": "/assets/images/items/savage-claws.png",
    "Scythe": "/assets/images/items/scythe.png",
    "Skull Crusher": "/assets/images/items/skull-crusher.png",
    "Tachi": "/assets/images/items/tachi.png",
    "Uchigatana": "/assets/images/items/uchigatana.png",
    "Grave Maker": "/assets/images/items/grave-maker.png",
    "Greater Battleaxe": "/assets/images/items/greater-battleaxe.png",
    "Wyvern Axe": "/assets/images/items/wyvern-axe.png",
    "Hammerhead Mace": "/assets/images/items/hammerhead-mace.png",
    "Dark Knight Chestplate": "/assets/images/items/dark-knight-chestplate.png",
    "Dark Knight Helmet": "/assets/images/items/dark-knight-helmet.png",
    "Dark Knight Leggings": "/assets/images/items/dark-knight-leggings.png",
    "Knight Chestplate": "/assets/images/items/knight-chestplate.png",
    "Knight Helmet": "/assets/images/items/knight-helmet.png",
    "Knight Leggings": "/assets/images/items/knight-leggings.png",
    "Light Chestplate": "/assets/images/items/light-chestplate.png",
    "Light Helmet": "/assets/images/items/light-helmet.png",
    "Light Leggings": "/assets/images/items/light-leggings.png",
    "Medium Chestplate": "/assets/images/items/medium-chestplate.png",
    "Medium Helmet": "/assets/images/items/medium-helmet.png",
